...
describe('POST /api/webhooks/stripe', () => {
  ...
  it('restores the previous refund total when the current pending refund fails', async () => {
    const priorRefundedAt = new Date('2025-06-01T12:00:00.000Z')
    mocks.constructWebhookEventMock.mockReturnValue({
  ...
  it('ignores stale refund.updated failures for non-current refund ids', async () => {
    mocks.constructWebhookEventMock.mockReturnValue({
