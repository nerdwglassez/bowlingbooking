...
| Settings → Integrations | Untitled list | [Integrations](https://www.figma.com/design/BYKelzNYd141jdsvslOABk/%E2%9D%96-Untitled-UI-Figma-%E2%80%93-PRO-STYLES--v8.0--KTWJ8mYFqVpN--Copy-?node-id=1677-405610) | `/staff/settings/integrations` | Connected apps rows: icon, Add integration / View details, enable toggle; connect & manage panels; no ⌘K |
