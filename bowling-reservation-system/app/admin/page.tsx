...
export default function AdminPage() {
  ...
  return (
    <div className="px-4 py-6 sm:px-0">
      ...
      {/* Quick Actions - Staff Features */}
      <div className="bg-white p-6 rounded-lg shadow-md mb-6">
        <h2 className="text-xl font-semibold mb-4">Staff Features</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link href="/staff/bookings/create">
            <div className="border-2 border-blue-200 rounded-lg p-4 hover:border-blue-400 hover:bg-blue-50 transition cursor-pointer">
          ...
          <Link href="/staff/check-in">
            <div className="border-2 border-blue-200 rounded-lg p-4 hover:border-blue-400 hover:bg-blue-50 transition cursor-pointer">
              <h3 className="font-semibold mb-2">Check In Customer</h3>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Link href="/admin/operating-hours">
            <div className="border-2 border-gray-200 rounded-lg p-4 hover:border-gray-400 hover:bg-gray-50 transition cursor-pointer">
              <h3 className="font-semibold mb-2">Operating Hours</h3>
              <p className="text-gray-600 text-sm">Configure when the bowling alley is open</p>
            </div>
          </Link>
          <Link href="/admin/lane-blocks">
            <div className="border-2 border-gray-200 rounded-lg p-4 hover:border-gray-400 hover:bg-gray-50 transition cursor-pointer">
              <h3 className="font-semibold mb-2">Lane Blocks</h3>
              <p className="text-gray-600 text-sm">Block lanes for maintenance or events</p>
            </div>
          </Link>
          <Link href="/admin/packages">
            <div className="border-2 border-gray-200 rounded-lg p-4 hover:border-gray-400 hover:bg-gray-50 transition cursor-pointer">
              <h3 className="font-semibold mb-2">Packages</h3>
              <p className="text-gray-600 text-sm">Manage food and party packages</p>
            </div>
          </Link>
          <Link href="/admin/settings">
            <div className="border-2 border-gray-200 rounded-lg p-4 hover:border-gray-400 hover:bg-gray-50 transition cursor-pointer">
              <h3 className="font-semibold mb-2">Settings</h3>
              <p className="text-gray-600 text-sm">Configure pricing and system settings</p>
            </div>
          </Link>
        </div>
      </div>
